...
**Bug-fix release · package 2.1.0.** Read [UPGRADE-SKYMEET-V2.md](UPGRADE-SKYMEET-V2.md) before updating an existing Render/Neon deployment.
...
```json
{"ok":true,"version":"2.1.0","storage":"postgresql"}
```
